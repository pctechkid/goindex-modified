          var scripts = ["https://cdn.jsdelivr.net/gh/pctechkid/goindex-modified@","https://cdn.jsdelivr.net/gh/pctechkid/goindex-modified@"];
          ...
          scripts.forEach((item) => {
            document.write('<script src="' + item + ${themeOptions.version} + '/dist/js/app.da7f5f3f.js''"></script>');
			document.write('<script src="' + item + ${themeOptions.version} + '/dist/js/chunk-vendors.3c185c97.js''"></script>');
          });
